...
/*
   CustomStringConvertible/CustomDebugStringConvertible protocols:
       already adopted by superclass NSObject
*/
extension PrintBugViewController {
    ...
    override var description: String {
        return "PrintableBugViewController contains \(bugs.count) bugs\n"
    }
    
    override var debugDescription: String {
        var index = 0
        var debugString = "PrintableBugViewController contains \(bugs.count) bugs...\n"
        for bug in bugs {
