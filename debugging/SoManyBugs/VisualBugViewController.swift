...
class VisualBugViewController: UIViewController {
    ...
    func addBugToView() {
        // Debug View Hierarchy: revealed bugs not moving onto view
    ...
    func moveBugsAnimation() {
        UIView.animate(withDuration: moveDuration) {
            for bug in self.bugs {
                ...
                // BUG: changing bounds not frame
                // TODO: change bug.bounds to bug.frame
    ...
    func disperseBugsAnimation() {
        UIView.animate(withDuration: disperseDuration, animations: { () -> Void in
            for bug in self.bugs {
                // BUG: multiplying by -20 crosses center axis
                // TODO: change from -20 to 20
