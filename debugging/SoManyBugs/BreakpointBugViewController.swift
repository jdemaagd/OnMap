...
class BreakpointBugViewController: UIViewController {
    ...
    let maxBugs = 100           // was set to 0, kept it from entering bug count loop
    ...
    func addBugToView() {
        if bugs.count < maxBugs {
            ...
            view.addSubview(newBug)     // bug was not added to view
    ...
    func moveBugsAnimation() {
        ...
        // addBugToView()      // source of adding multiple bugs
    }
...
extension BreakpointBugViewController {
    ...
    override var description: String {
        return "Hello from BreakpointBugViewController: CustomStringConvertible"
    }

    override var debugDescription: String {
        return "Hello from BreakpointBugViewController: CustomDebugStringConvertible"
    }
    
    @objc func handleSingleTap(_ recognizer: UITapGestureRecognizer) {
        addBugToView()
        //addBugToView()    // adds second bug
    }
}
